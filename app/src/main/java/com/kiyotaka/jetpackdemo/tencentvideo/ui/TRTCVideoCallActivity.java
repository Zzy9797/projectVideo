package com.kiyotaka.jetpackdemo.tencentvideo.ui;
...
import com.kiyotaka.jetpackdemo.tencentvideo.videolayout.TRTCVideoLayout;
import com.kiyotaka.jetpackdemo.tencentvideo.videolayout.TRTCVideoLayoutManager;
...
public class TRTCVideoCallActivity extends AppCompatActivity {
    ...
    public static final String PARAM_BEINGCALL_TYPE = "call_type";
     ...
     */
    public static void startBeingCall(Context context, UserModel beingCallUserModel, List<UserModel> otherInvitingUserModel, int callType) {
        Intent starter = new Intent(context, TRTCVideoCallActivity.class);
        ...
        starter.putExtra(PARAM_BEINGCALL_TYPE, callType);
        context.startActivity(starter);
    }
    ...
    private void initData() {
        ...
        mCall = intent.getIntExtra(PARAM_BEINGCALL_TYPE, 0);
    ...
    public void showWaitingResponseView() {
        ...
        if (mCall == TRTCVideoCallImpl.CallModel.CALL_TYPE_AUDIO) {
            mITRTCVideoCall.closeCamera();
        } else {
