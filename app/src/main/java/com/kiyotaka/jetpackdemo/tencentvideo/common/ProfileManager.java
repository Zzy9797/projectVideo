package com.kiyotaka.jetpackdemo.tencentvideo.common;
...
public class ProfileManager {
    ...
    public void login(String sig,String userId, String sms, final ActionCallback callback) {
        isLogin = true;
        setUserId(userId);
        ...
        userModel.userSig = sig;
        setUserModel(userModel);
        callback.onSuccess();
    }

    public void autoLogin(String sig,String userId, String token, final ActionCallback callback) {
        isLogin = true;
        setUserId(userId);
        UserModel userModel = new UserModel();
        userModel.userAvatar = getAvatarUrl(userId);
