...
public interface ITRTCVideoCall {
    ...
    /**
     * C2C邀请通话，被邀请方会收到 {@link TRTCVideoCallListener#onInvited } 的回调
    ...
    /**
     * IM群组邀请通话，被邀请方会收到 {@link TRTCVideoCallListener#onInvited } 的回调
     * 如果当前处于通话中，可以继续调用该函数继续邀请他人进入通话，同时正在通话的用户会收到 {@link TRTCVideoCallListener#onGroupCallInviteeListUpdate(List)} 的回调
     *
    ...
    /**
     * 当您作为被邀请方收到 {@link TRTCVideoCallListener#onInvited } 的回调时，可以调用该函数接听来电
     */
    void accept();

    /**
     * 当您作为被邀请方收到 {@link TRTCVideoCallListener#onInvited } 的回调时，可以调用该函数拒绝来电
     */
    void reject();
     ...
     * 处于通话中的用户会收到 {@link TRTCVideoCallListener#onUserVideoAvailable(java.lang.String, boolean)} 回调
     *
